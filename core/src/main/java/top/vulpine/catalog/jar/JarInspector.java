...
public final class JarInspector {
     ...
     */
    public static PluginDescriptor inspect(Path jar) {
    ...
    private static Declared readDescriptor(ZipFile zip) {
        ...
        if (bukkit != null) {
            Declared declared = readYamlDescriptor(zip, bukkit, PluginDescriptor.Kind.BUKKIT);
        ...
        if (paper != null) {
            Declared declared = readYamlDescriptor(zip, paper, PluginDescriptor.Kind.PAPER);
    ...
    private static Declared readVelocityDescriptor(ZipFile zip, ZipEntry entry) {
        ...
        try (InputStream in = zip.getInputStream(entry);
            ...
            return new Declared(name, string(json, "version"), string(json, "main"),
                    null, PluginDescriptor.Kind.VELOCITY);
    ...
    private static final class Declared {
        ...
        private static Declared empty() {
            return new Declared(null, null, null, null, PluginDescriptor.Kind.NONE);
        }
