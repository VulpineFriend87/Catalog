...
public final class PluginJar {
    ...
    public PluginJar(Path path, long size, long lastModified, String sha512, JarInfo info) {
        this.path = path;
    ...
    public String toString() {
        return "PluginJar(" + fileName + ", " + (info.isPlugin() ? info.pluginName() : "no descriptor") + ")";
    }
